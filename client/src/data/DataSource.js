...
const techs = {
  ...
  const productdata = [
    
      {
        ...
        details: "Advanced security Access, data control, and Cyberthreat protection",
        linkurl: "#",
        btn: "Get it now"
      },
      {
        ...
        details: "The FortiGate 100F series Next Generation Firewall (NGFW) capabilities",
        linkurl: "#",
        btn: "Get it now"
      },
      {
  ...
  export { techs, sliderdata, productdata};